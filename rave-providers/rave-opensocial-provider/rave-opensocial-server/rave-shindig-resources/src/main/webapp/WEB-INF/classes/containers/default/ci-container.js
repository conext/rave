...
"gadgets.features" : {
  ...
  "views" : {
    "profile" : {
      "isOnlyVisible" : false,
      "urlTemplate" : "http://conext-portal.appengine.flow.ch${CONTEXT_ROOT}/gadgets/profile?{var}",
      "aliases": ["DASHBOARD", "default"]
    },
    "canvas" : {
      "isOnlyVisible" : true,
      "urlTemplate" : "http://conext-portal.appengine.flow.ch${CONTEXT_ROOT}/gadgets/canvas?{var}",
      "aliases" : ["FULL_PAGE"]
    },
    "default" : {
      "isOnlyVisible" : false,
      "urlTemplate" : "http://conext-portal.appengine.flow.ch${CONTEXT_ROOT}/gadgets/default?{var}",
